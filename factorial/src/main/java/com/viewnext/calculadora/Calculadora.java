...
public class Calculadora {
	 ...
	 *                                       que 0
	 */
	public long factorial(final int num) throws CalculadoraFactorialException {

		long nfactorial = 1; // Inicializamos el parámetro nfactorial que define el número que se quiere
								// factorizar

		Validaciones.validadorFactorial(); // Llamamos al método validadorFactorial de la clase Validadciones
